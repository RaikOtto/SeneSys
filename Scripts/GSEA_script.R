...
cohort_vec = meta_data$Left_Right
...
write.table(cls_file, "~/SeneSys/GSEA/Data_9461.Left_Right.cls",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(cls_file, "~/SeneSys/GSEA/Data_9461.Left_Right.cls.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
...
write.table(output_gct, "~/SeneSys/GSEA/Data_9461.DESeq2.Left_Right.gct",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(output_gct, "~/SeneSys/GSEA/Data_9461.DESeq2.Left_Right.gct.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
