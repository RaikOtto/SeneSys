...
cohort_vec = meta_data$ADROHT_binary
...
write.table(cls_file, "~/SeneSys/GSEA/Schmitz.ADROHT_high_low.cls",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(cls_file, "~/SeneSys/GSEA/Schmitz.ADROHT.PS_high_low.cls.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
...
write.table(output_gct, "~/SeneSys/GSEA/Schmitz.ADROHT.gct",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(output_gct, "~/SeneSys/GSEA/Schmitz.ADROHT.gct.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
