...
cohort_vec = meta_data$Left_Right_ML_core_50
...
write.table(cls_file, "~/SeneSys/GSEA/GSE98588.NL_core_left_right_50.cls",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(cls_file, "~/SeneSys/GSEA/GSE98588.NL_core_left_right_50.cls.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
